...
public class RegistrationView implements RegistrationViewCallBack {
    private RegistrationControllerCallBack registrationController;
    ...
    public void newAccount() {
        ...
        do {
            ...
            switch(choice) {
                ...
                case 2: if(isAdded)displayCustomer(); break;
                case 3: System.exit(0);
                default : System.out.println("Invalid choice: ");
            }
    ...
    private void submit() {
		...
		choice = scanner.nextInt();
        switch(choice) {
            case 1: System.out.println("Registration completed.");
    ...
    private void addCustomer() {
        ...
        registrationController.addCustomer(firstName, lastName, age, gender, city, Branch, contact);
        isAdded = true;
    }
    private void displayCustomer() {
        ...
        registrationController.displayCustomer(customerID);
    }
    ...
    private void editCustomer(Customer customer) {
        ...
        do{
            ...
            switch(choice) {
                case 1: System.out.println("Current First Name: " + customer.getFirstName());
                        System.out.println("New First Name : ");
                        String firstName = getString();
                        customer.setFirstName(firstName);
                        break;
                case 2: System.out.println("Current Last Name: " + customer.getLastName());
                        System.out.println("New Last Name : ");
                        String lastName = getString();
                        customer.setLastName(lastName);
                        break;
                case 3: System.out.println("Current Age: " + customer.getAge());
                        System.out.println("New Age : ");
                        int age = getInt();
                        customer.setAge(age);
                        break;
                case 4: System.out.println("Current Gender: " + customer.getGender());
                        System.out.println("Gender :");
                        String gender = getString();
                        customer.setGender(gender);
                        break;
                case 5: System.out.println("Current City: " + customer.getCity());
                        System.out.println("City :");
                        String city = getString();
                        customer.setCity(city);
                        break;
                case 6: System.out.println("Current Branch : " + customer.getBranch());
                        System.out.println("Branch :");
                        String Branch = getString();
                        customer.setBranch(Branch);
                        break;
                case 7: System.out.println("Current Contact: " + customer.getContact());
                        System.out.println("Contact :");
                        long contact = Long.parseLong(getString());
                        customer.setContact(contact);
                        break;
                case 8: System.out.println("Main menu");
                        displayCustomer();
                        break;
                default: System.out.println("Invalid choice."); 
            }
    ...
    private String selectBranch() {
        ...
        String branch = (getInt() == 1) ? "Tenkasi" : (getInt() == 2) ? "Chennai" : (getInt() == 3) ? "Peravurani" : selectBranch();
        return branch;
    }
    @Override
    ...
    public void showCustomer(Customer customer) {
        ...
        if(getString().toUpperCase().equals("Y")) editCustomer(customer);
